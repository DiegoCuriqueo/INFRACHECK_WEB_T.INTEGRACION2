        ...
        <>
          <span
            className={`absolute left-0 top-1/2 -translate-y-1/2 h-6 w-1 rounded-r-md transition ${
              isActive ? "bg-indigo-500 shadow-[0_0_10px_2px_rgba(99,102,241,0.6)]" : "bg-transparent group-hover:bg-indigo-400/60"
            }`}
          />
          {icon}
...
export default function Sidebar() {
  ...
  return (
    <aside className="h-full w-[260px] bg-[#0B1220] bg-gradient-to-b from-[#0B1220] to-[#0A0F1A] border-r border-slate-800/80 px-4 py-5">
